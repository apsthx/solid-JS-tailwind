...
import { iconMasterCard2 } from "../../../helper/img";

export default function Charts() {
  onMount(async () => {
    const module = await import("../../../assets/js/widget/widgets-charts.js");
  
    module.initializeWidgetsCharts();
  });
  return (
    <>
              ...
              <div class="card-body pb-4">
                <div class="d-flex align-items-center justify-content-between mb-4">
                  ...
                  <div class="p-2 bg-primary-subtle rounded-1 d-inline-block">
                    <img src={iconMasterCard2} alt="matdash-img" class="img-fluid" width="24" height="24" />
                  </div>
                </div>
                <div class="d-flex align-items-center mb-7 pb-8">
