...
import { User3, User5, User6, User7, User8, BlogBg } from "../../../helper/img.jsx";
...
export default function Analytical() {
  onMount(async () => {
    const module = await import("../../../assets/js/dashboards/dashboard.js");
    ...
    <>
      <div class="container-fluid mw-100">
        ...
        <div class="row">
                  ...
                  <table class="table mb-0 text-nowrap varient-table align-middle fs-3">
                    ...
                    <tbody>
                      <tr>
                        <td class="px-0">
                          <div class="d-flex align-items-center">
                            <img src={User3} class="rounded-circle" width="35" alt="flexy" />
                            <div class="ms-3">
                      ...
                      <tr>
                        <td class="px-0">
                          <div class="d-flex align-items-center">
                            <img src={User5} class="rounded-circle" width="35" alt="flexy" />
                            <div class="ms-3">
                      ...
                      <tr>
                        <td class="px-0">
                          <div class="d-flex align-items-center">
                            <img src={User6} class="rounded-circle" width="35" alt="flexy" />
                            <div class="ms-3">
                      ...
                      <tr>
                        <td class="px-0">
                          <div class="d-flex align-items-center">
                            <img src={User7} class="rounded-circle" width="35" alt="flexy" />
                            <div class="ms-3">
                      ...
                      <tr>
                        <td class="px-0">
                          <div class="d-flex align-items-center">
                            <img src={User8} class="rounded-circle" width="35" alt="flexy" />
                            <div class="ms-3">
          ...
          <div class="col-lg-4">
            <div class="card">
              <img src={BlogBg} class="card-img-top blog-img" alt="..." />
              <div class="card-body">
                ...
                <div class="border-top pt-4 d-flex align-items-center justify-content-between">
                  <div class="d-flex align-items-center">
                    <a href="javascript:void(0)" class="me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="John Deo">
                      <img src={User5} class="rounded-circle" width="40" height="40" alt="flexy" />
                    </a>
                    <a href="javascript:void(0)" class="me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Micheal Doe">
                      <img src={User3} class="rounded-circle" width="40" height="40" alt="flexy" />
                    </a>
