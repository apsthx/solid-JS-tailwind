...
import { User3, User5, User6, User7, Product1, Product2, Product3, Product4, BlogImg2 } from "../../../helper/img.jsx";
...
export default function ECommerce() {
  onMount(async () => {
    const module = await import("../../../assets/js/dashboards/dashboard2.js");

    module.initializeCharts2();
  });
                      ...
                      <table class="table mb-0 align-middle text-nowrap fs-3">
                        <tbody>
                          <tr>
                            <td class="px-0">
                              <div class="d-flex align-items-center">
                                <img src={Product2} class="rounded" alt="product" />
                                <div class="ms-4">
                          ...
                          <tr>
                            <td class="px-0">
                              <div class="d-flex align-items-center">
                                <img src={Product3} class="rounded" alt="product" />
                                <div class="ms-4">
                          ...
                          <tr>
                            <td class="px-0">
                              <div class="d-flex align-items-center">
                                <img src={Product1} class="rounded" alt="product" />
                                <div class="ms-4">
                          ...
                          <tr>
                            <td class="px-0 pb-0">
                              <div class="d-flex align-items-center">
                                <img src={Product4} class="rounded" alt="product" />
                                <div class="ms-4">
                  ...
                  <div class="mt-4 pb-4 border-bottom">
                    ...
                    <div class="mt-2 pt-1 mb-2">
                      <a href="javascript:void(0)" class="me-1">
                        <img src={User3} data-bs-toggle="tooltip" data-bs-placement="top" title="John" class="rounded-circle" width="35" />
                      </a>
                      <a href="javascript:void(0)" class="me-1">
                        <img src={User5} data-bs-toggle="tooltip" data-bs-placement="top" title="Nirav" class="rounded-circle" width="35" />
                      </a>
                      <a href="javascript:void(0)" class="me-1">
                        <img src={User6} data-bs-toggle="tooltip" data-bs-placement="top" title="Sunil" class="rounded-circle" width="35" />
                      </a>
                      <a href="javascript:void(0)">
                        <img src={User7} data-bs-toggle="tooltip" data-bs-placement="top" title="Maruti" class="rounded-circle" width="35" />
                      </a>
                    </div>
                  </div>
          ...
          <div class="col-lg-4">
            <div class="card">
              <div class="card-body">
                ...
                <div class="mt-4 pt-2">
                  <img src={BlogImg2} class="blog-img rounded w-100" height="180" alt="flexy" />
