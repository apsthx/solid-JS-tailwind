...
export default function Api() {
  onMount(async () => {
    const module = await import("../../../assets/js/datatable/datatable-api.init.js");

    module.initializeApiInit();
  });
  onMount(() => {
    
    import("../../../assets/libs/datatables.net/js/jquery.dataTables.min.js").then(({ initializeDataTable }) => {
      initializeDataTable();
    });
    // import("../../../assets/js/datatable/datatable-api.init.js").then(({ initializeDataTable }) => {
    //   initializeDataTable();
    // });
  });
  return (
      ...
      <div class="page-titles mb-7 mb-md-5">
        <div class="row">
          <div class="col-lg-8 col-md-6 col-12 align-self-center">
            ...
            <h2 class="mb-0 fw-bolder fs-8">Datatable Api</h2>
          </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <button id="button" class="btn btn-primary mb-2">
              <i class="ri-filter-line" /> Row count
            </button>
            <div class="table-responsive">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <button class="btn btn-primary me-1 inputs-submit">
              <i class="ri-file-fill align-middle" /> Submit form
            </button>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <button id="delete-row" class="btn btn-primary me-1">
              <i class="ri-delete-bin-line fs-5 align-middle" />
              Delete selected row
            </button>
            <div class="table-responsive mt-3">
