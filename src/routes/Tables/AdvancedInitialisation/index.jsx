...
export default function AdvancedInitialisation() {
    onMount(() => {
        ...
        import("../../../assets/libs/datatables.net/js/jquery.dataTables.min.js").then(({ initializeDataTableAdvanced }) => {
            initializeDataTableAdvanced();
        });
        import("../../../assets/js/add/dataTables.buttons.min.js").then(({ initializeDataTableAdvanced }) => {
            initializeDataTableAdvanced();
        });
        import("../../../assets/js/add/jszip.min.js").then(({ initializeDataTableAdvanced }) => {
            initializeDataTableAdvanced();
        });
        import("../../../assets/js/add/pdfmake.min.js").then(({ initializeDataTableAdvanced }) => {
            initializeDataTableAdvanced();
        });
        import("../../../assets/js/add/vfs_fonts.js").then(({ initializeDataTableAdvanced }) => {
            initializeDataTableAdvanced();
        });
        import("../../../assets/js/add/buttons.html5.min.js").then(({ initializeDataTableAdvanced }) => {
            initializeDataTableAdvanced();
        });
        import("../../../assets/js/add/buttons.print.min.js").then(({ initializeDataTableAdvanced }) => {
            initializeDataTableAdvanced();
        });
        import("../../../assets/js/datatable/datatable-advanced.init.js").then(({ initializeDataTableAdvanced }) => {
            initializeDataTableAdvanced();
        });
    });
    return (
            ...
            <div class="page-titles mb-7 mb-md-5">
                <div class="row">
                    <div class="col-lg-8 col-md-6 col-12 align-self-center">
                        ...
                        <h2 class="mb-0 fw-bolder fs-8">Datatable Advanced</h2>
                    </div>
