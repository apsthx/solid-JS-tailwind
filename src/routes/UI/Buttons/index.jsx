    ...
    <>
      <div class="container-fluid mw-100">
        <div class="page-titles mb-7 mb-md-5">
          <div class="row">
            <div class="col-lg-8 col-md-6 col-12 align-self-center">
              ...
              <h2 class="mb-0 fw-bolder fs-8">Buttons</h2>
            </div>
          ...
          <div class="col-xl-6">
            <div class="card">
              <div class="card-body">
                ...
                <p class="mb-3 card-subtitle">Use a classes
                  <mark> <code>btn btn-success</code>
                  </mark>to quickly create a General btn.</p>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <p class="mb-3 card-subtitle">Use
                  <mark> <code>btn-light</code>
                  </mark>class for light buttons</p>
                <div class="button-group">
          ...
          <div class="col-xl-6">
            <div class="card">
              <div class="card-body">
                ...
                <p class="mb-3 card-subtitle">Use a classes
                  <mark> <code>btn btn-outline-success</code>
                  </mark>to quickly create a General btn.</p>
                <div class="button-group">
        ...
        <div class="col-xl-6">
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-3 card-subtitle">Use a classes
                <mark> <code>btn btn-rounded btn-success</code>
                </mark>to quickly create a General btn.</p>
              <div class="button-group">
        ...
        <div class="col-xl-6">
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-3 card-subtitle">Use a classes
                <mark> <code>btn btn-rounded bg-success-subtle</code>
                </mark>to quickly create a General btn.</p>
              <div class="button-group">
                <button type="button" class="btn btn-rounded bg-primary-subtle text-primary">Primary</button>
                <button type="button" class="btn btn-rounded bg-secondary-subtle text-secondary">Secondary</button>
                <button type="button" class="btn btn-rounded bg-success-subtle text-success">Success</button>
                <button type="button" class="btn waves-effect waves-light btn-rounded bg-info-subtle text-info">Info</button>
                <button type="button" class="btn btn-rounded bg-warning-subtle text-warning">Warning</button>
                <button type="button" class="btn waves-effect waves-light btn-rounded bg-danger-subtle text-danger">Danger</button>
              </div>
            </div>
          </div>
        </div>
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-3 card-subtitle">Use a classes
                <mark> <code>btn btn-rounded btn-outline-success</code>
                </mark>to quickly create a General btn.</p>
              <div class="button-group">
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-3 card-subtitle">Use a classes
                <mark> <code>btn btn-lg btn-success</code>
                </mark>to quickly create a General btn.</p>
              <div class="button-group">
                <button type="button" class="btn btn-lg btn-primary">Large .btn-lg</button>
                <button type="button" class="btn btn-primary">Normal .btn</button>
                <button type="button" class="btn btn-sm btn-primary">Small .btn-sm</button>
                <button type="button" class="btn btn-xs btn-primary">Tiny .btn-xs</button>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-3 card-subtitle">Use a classes
                <mark> <code>btn btn-lg btn-rounded btn-success</code>
                </mark>to create a btn.</p>
              <div class="button-group">
                <button type="button" class="btn btn-lg btn-rounded btn-primary">Large .btn-lg</button>
                <button type="button" class="btn btn-rounded btn-primary">Normal .btn</button>
                <button type="button" class="btn btn-rounded btn-sm btn-primary">Small .btn-sm</button>
                <button type="button" class="btn btn-rounded btn-xs btn-primary">Tiny .btn-xs</button>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-6 col-xl-3 d-flex align-items-stretch">
          <div class="card w-100">
            <div class="card-body">
              ...
              <p class="mb-3 card-subtitle">Use a classes for
                <mark> <code>d-grid gap-2</code>
                </mark>creating a block button.</p>
        ...
        <div class="col-lg-6 col-xl-3 d-flex align-items-stretch">
          <div class="card w-100">
            <div class="card-body">
              ...
              <p class="mb-3 card-subtitle">Use a classe
                <mark> <code>rounded-pill</code>
                </mark>.</p>
              <div class="row justify-content-center">
                <div class="col-md-12 d-grid gap-2">
                  <button type="button" class="btn rounded-pill waves-effect waves-light btn-primary">Primary</button>
                  <button type="button" class="btn rounded-pill waves-effect waves-light btn-secondary">Secondary</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-6 col-xl-3 d-flex align-items-stretch">
          <div class="card w-100">
            <div class="card-body">
              ...
              <p class="mb-3 card-subtitle">Use a classes
                <mark> <code>d-grid gap-2</code>
                </mark>to quickly create a block button.</p>
              <div class="row justify-content-center">
                <div class="col-md-12 d-grid gap-2">
                  <button type="button" class="btn waves-effect waves-light bg-primary-subtle text-primary ">Primary</button>
                  <button type="button" class="btn waves-effect waves-light bg-secondary-subtle text-secondary ">Secondary</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-6 col-xl-3 d-flex align-items-stretch">
          <div class="card w-100">
            <div class="card-body">
              <h4 class="card-title">Rounded Block buttons</h4>
              <p class="mb-3 card-subtitle">Use a classes
                <mark> <code>btn btn-block btn-success</code>
                </mark>to quickly create a General btn.</p>
              <div class="row justify-content-center">
                <div class="col-md-12 d-grid gap-2">
                  <button type="button" class="btn rounded-pill waves-effect waves-light bg-primary-subtle text-primary ">Primary</button>
                  <button type="button" class="btn rounded-pill waves-effect waves-light bg-secondary-subtle text-secondary ">Secondary</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-6 col-xl-3 d-flex align-items-stretch">
          <div class="card w-100">
            <div class="card-body">
              ...
              <div class="row justify-content-center">
                <div class="col-md-12 d-grid gap-2">
                  <button type="button" class="btn rounded-pill waves-effect waves-light btn-outline-primary">Primary</button>
                  <button type="button" class="btn rounded-pill waves-effect waves-light btn-outline-secondary">Secondary</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-6 col-xl-3 d-flex align-items-stretch">
          <div class="card w-100">
            <div class="card-body">
              ...
              <div class="row justify-content-center">
                <div class="col-md-12 d-grid gap-2">
                  <button type="button" class="btn btn-lg waves-effect waves-light btn-outline-primary">Primary</button>
                  <button type="button" class="btn btn-lg waves-effect waves-light btn-outline-secondary">Secondary</button>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="row button-group">
                <div class="col-lg-6">
                  <button type="button" class="justify-content-center w-100 btn mb-1 btn-primary d-flex align-items-center">
                    <i class="ti ti-heart fs-4 me-2" />Heart</button>
              ...
              <div class="row button-group">
                <div class="col-lg-6">
                  <button type="button" class="justify-content-center w-100 btn mb-1 btn-rounded btn-primary d-flex align-items-center">
                    <i class="ti ti-send fs-4 me-2" />Send</button>
              ...
              <div class="row button-group">
                <div class="col-lg-6">
                  <button class="btn mb-1 d-flex align-items-center justify-content-center w-100 btn-outline-primary waves-effect waves-light" type="button">
                    <i class="ti ti-mail fs-4 me-2" />Mail</button>
              ...
              <div class="row button-group">
                <div class="col-lg-6">
                  <button type="button" class="justify-content-center w-100 btn mb-1 bg-primary-subtle text-primary  d-flex align-items-center">
                    <i class="ti ti-bell fs-4 me-2" />Alert</button>
              ...
              <div class="row button-group">
                <div class="col-lg-6">
                  <button type="button" class="justify-content-center w-100 btn mb-1 btn-rounded bg-primary-subtle text-primary  d-flex align-items-center">
                    <i class="ti ti-clock-hour-4 fs-4 me-2" />Time</button>
        ...
        <div class="col-lg-6 d-flex align-items-stretch">
          <div class="card w-100">
            <div class="card-body">
              ...
              <div class="button-group">
                <button type="button" class="btn mb-1 btn-secondary rounded-circle round d-inline-flex align-items-center justify-content-center px-2">
                  <i class="fs-5 ti ti-heart" />
                </button>
                <button type="button" class="btn mb-1 btn-primary rounded-circle round d-inline-flex align-items-center justify-content-center px-2">
                  <i class="fs-5 ti ti-heart" />
                </button>
                <button type="button" class="btn mb-1 btn-success rounded-circle round d-inline-flex align-items-center justify-content-center px-2">
                  <i class="fs-5 ti ti-heart" />
                </button>
                <button type="button" class="btn mb-1 btn-info rounded-circle round d-inline-flex align-items-center justify-content-center px-2">
                  <i class="fs-5 ti ti-heart" />
                </button>
                <button type="button" class="btn mb-1 btn-warning rounded-circle round d-inline-flex align-items-center justify-content-center px-2">
                  <i class="fs-5 ti ti-heart" />
                </button>
                <button type="button" class="btn mb-1 btn-danger rounded-circle round d-inline-flex align-items-center justify-content-center px-2">
                  <i class="fs-5 ti ti-heart" />
                </button>
              </div>
              <div class="my-4">
              ...
              <div class="button-group">
                <button type="button" class="btn bg-secondary-subtle rounded-circle round d-inline-flex align-items-center justify-content-center px-2">
                  <i class="fs-5 ti ti-heart" />
                </button>
                <button type="button" class="btn bg-primary-subtle rounded-circle round d-inline-flex align-items-center justify-content-center px-2">
                  <i class="fs-5 ti ti-heart" />
                </button>
                <button type="button" class="btn bg-success-subtle rounded-circle round d-inline-flex align-items-center justify-content-center px-2">
                  <i class="fs-5 ti ti-heart" />
                </button>
                <button type="button" class="btn bg-info-subtle rounded-circle round d-inline-flex align-items-center justify-content-center px-2">
                  <i class="fs-5 ti ti-heart" />
                </button>
                <button type="button" class="btn bg-warning-subtle rounded-circle round d-inline-flex align-items-center justify-content-center px-2">
                  <i class="fs-5 ti ti-heart" />
                </button>
                <button type="button" class="btn bg-danger-subtle rounded-circle round d-inline-flex align-items-center justify-content-center px-2">
                  <i class="fs-5 ti ti-heart" />
                </button>
              </div>
            </div>
            ...
            <div class="card-body">
              ...
              <div class="button-group">
                <button type="button" class="d-inline-flex align-items-center justify-content-center btn btn-secondary rounded-circle btn-lg round-48">
                  <i class="fs-5 ti ti-file-description" />
                </button>
        ...
        <div class="col-lg-6 col-xl-4 d-flex align-items-stretch">
          <div class="card w-100">
            <div class="card-body">
              ...
              <p class="mb-3 card-subtitle">Wrap a series of buttons with
                <mark> <code>.btn</code>
                </mark>in
                <mark> <code>.btn-group</code>
                </mark>
              </p>
              <div class="btn-group mb-2" role="group" aria-label="Basic example">
                <button type="button" class="btn bg-primary-subtle text-primary ">Left</button>
                <button type="button" class="btn bg-primary-subtle text-primary ">Middle</button>
                <button type="button" class="btn bg-primary-subtle text-primary ">Right</button>
              </div>
              <div class="btn-group mb-2" role="group" aria-label="Basic example">
                <button type="button" class="btn bg-secondary-subtle text-secondary ">
                  <i class="ti ti-align-left fs-4" />
                </button>
                <button type="button" class="btn bg-secondary-subtle text-secondary ">
                  <i class="ti ti-align-justified fs-4" />
                </button>
                <button type="button" class="btn bg-secondary-subtle text-secondary ">
                  <i class="ti ti-align-right fs-4" />
                </button>
              </div>
              <div class="btn-group mb-2" role="group" aria-label="Basic example">
                <button type="button" class="btn bg-success-subtle text-success">
                  <i class="ti ti-player-skip-back fs-4" />
                </button>
                <button type="button" class="btn bg-success-subtle text-success">
                  <i class="ti ti-player-play fs-4" />
                </button>
                <button type="button" class="btn bg-success-subtle text-success">
                  <i class="ti ti-player-skip-forward fs-4" />
                </button>
              </div>
            </div>
          </div>
          ...
          <div class="card w-100">
            <div class="card-body">
              ...
              <p class="mb-3 card-subtitle">Wrap a series of buttons with
                ...
                <mark> <code>.btn-group-lg , *-sm</code>
                </mark>
              </p>
            ...
            <div class="card-body">
              ...
              <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                <div class="btn-group me-2 mb-2" role="group" aria-label="First group">
                  <button type="button" class="btn bg-info-subtle text-info  disabled">1</button>
                  <button type="button" class="btn btn-info">2</button>
                  <button type="button" class="btn bg-info-subtle text-info ">3</button>
                  <button type="button" class="btn bg-info-subtle text-info ">4</button>
                </div>
                <div class="btn-group me-2 mb-2" role="group" aria-label="Second group">
                  <button type="button" class="btn bg-info-subtle text-info ">5</button>
                  <button type="button" class="btn bg-info-subtle text-info ">6</button>
                  <button type="button" class="btn bg-info-subtle text-info ">7</button>
                </div>
                <div class="btn-group mb-2" role="group" aria-label="Third group">
                  <button type="button" class="btn bg-info-subtle text-info ">8</button>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                <div class="btn-group me-2 mb-2" role="group" aria-label="First group">
                  <button type="button" class="btn btn-secondary">
                    <i class="ti ti-printer fs-4" />
                  </button>
                  <button type="button" class="btn btn-secondary">
                    <i class="ti ti-trash fs-4" />
                  </button>
                  <button type="button" class="btn btn-secondary">
                    <i class="ti ti-device-floppy fs-4" />
                  </button>
                  <button type="button" class="btn btn-secondary">
        ...
        <div class="col-lg-6 col-xl-4 d-flex align-items-stretch">
          <div class="card w-100">
            <div class="card-body">
              <h4 class="card-title">Toolbar with Jutify Content Input Group</h4>
            ...
            <div class="card-body">
              ...
              <div>
                <button type="button" class="btn bg-success-subtle text-success  mb-2" data-bs-toggle="button" aria-pressed="false">
                  <i class="ti ti-settings fs-4 text" />
                  <span class="text">Upload</span>
                  <i class="ti ti-check fs-4 text-active" />
          ...
          <div class="card w-100">
            <div class="card-body">
              ...
              <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                <button type="button" class="btn bg-primary-subtle btn-sm text-primary ">1</button>
                <button type="button" class="btn bg-primary-subtle btn-sm text-primary ">2</button>
                <div class="btn-group btn-group-sm" role="group">
                  <button id="btnGroupDrop1" type="button" class="btn bg-primary-subtle text-primary  dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>
              ...
              <h4 class="card-title mt-4">Nesting buttons with regular size</h4>
              <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                <button type="button" class="btn bg-primary-subtle text-primary  rounded-start">1</button>
                <button type="button" class="btn bg-primary-subtle text-primary ">2</button>
                <div class="btn-group" role="group">
                  <button id="btnGroupDrop1" type="button" class="btn bg-primary-subtle text-primary  dropdown-toggle rounded-end" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>
                  <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                    <a class="dropdown-item" href="javascript:void(0)">Dropdown link</a>
                    <a class="dropdown-item" href="javascript:void(0)">Dropdown link</a>
                  </div>
              ...
              <h4 class="card-title mt-4">Nesting buttons with large size</h4>
              <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                <button type="button" class="btn bg-primary-subtle btn-lg text-primary ">1</button>
                <button type="button" class="btn bg-primary-subtle btn-lg text-primary ">2</button>
        ...
        <div class="col-lg-6 d-flex align-items-stretch">
          <div class="card w-100">
            <div class="card-body">
              ...
              <p class="mb-3 card-subtitle">create vertical button with class of
                <mark> <code>.btn-group-vertical</code>
                </mark>
              </p>
              <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                <button type="button" class="btn bg-primary-subtle text-primary  rounded-top">Button</button>
                <button type="button" class="btn bg-primary-subtle text-primary ">Button</button>
                <button type="button" class="btn bg-primary-subtle text-primary ">Button</button>
                <button type="button" class="btn bg-primary-subtle text-primary ">Button</button>
                <button type="button" class="btn bg-primary-subtle text-primary ">Button</button>
                <button type="button" class="btn bg-primary-subtle text-primary  rounded-bottom">Button</button>
              </div>
              <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                <button type="button" class="btn bg-primary-subtle text-primary  rounded-top">Button</button>
                <div class="btn-group" role="group">
                  <button id="btnGroupVerticalDrop1" type="button" class="btn bg-primary-subtle text-primary  dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>
                ...
                <button type="button" class="btn bg-primary-subtle text-primary ">Button</button>
                <div class="btn-group" role="group">
                  <button id="btnGroupVerticalDrop2" type="button" class="btn bg-primary-subtle text-primary  dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>
                ...
                <div class="btn-group" role="group">
                  <button id="btnGroupVerticalDrop3" type="button" class="btn bg-primary-subtle text-primary  dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>
                ...
                <div class="btn-group" role="group">
                  <button id="btnGroupVerticalDrop4" type="button" class="btn bg-primary-subtle text-primary  dropdown-toggle rounded-bottom" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>
