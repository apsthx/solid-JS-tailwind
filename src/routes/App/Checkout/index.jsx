...
import { PaymentComplete, S11, paypal, mastercard, payment } from "../../../helper/img";
export default function Checkout() {

  // Using SolidJS's lifecycle method to handle DOM interactions
  onMount(() => {
    // Any additional DOM manipulation logic can be handled here if necessary
    //Basic Example
    $("#example-basic").steps({
      headerTag: "h3",
      bodyTag: "section",
          ...
          <div class="wizard-content">
            <form action="#" class="tab-wizard wizard-circle">
                      ...
                      <tr>
                        <td class="border-bottom-0">
                          <div class="d-flex align-items-center gap-3 overflow-hidden">
                            <img src={S11} alt="matdash-img" class="img-fluid rounded" width="80" />
                            <div>
                      ...
                      <div class="card shadow-none border">
                        <div class="card-body p-4">
                          ...
                          <h6 class="d-flex align-items-center gap-2 my-4 fw-semibold fs-4">
                            <i class="ti ti-device-mobile fs-7" />9999501050
                          </h6>
                  ...
                  <div class="payment-option btn-group-active  card shadow-none border">
                    <div class="card-body p-4">
                      ...
                      <div class="row">
                            ...
                            <div class="position-relative mb-3 w-100 form-check btn-custom-fill ps-0">
                              ...
                              <label class="btn btn-outline-primary mb-0 p-3 rounded ps-5 w-100" for="btnradio3">
                                <div class="d-flex align-items-center">
                                  ...
                                  <img src={paypal} alt="matdash-img" class="img-fluid ms-auto" />
                                </div>
                              </label>
                            </div>
                            <div class="position-relative mb-3 form-check btn-custom-fill ps-0">
                              ...
                              <label class="btn btn-outline-primary mb-0 p-3 rounded ps-5 w-100" for="btnradio4">
                                <div class="d-flex align-items-center">
                                  ...
                                  <img src={mastercard} alt="matdash-img" class="img-fluid ms-auto" />
                                </div>
                              </label>
                            </div>
                        ...
                        <div class="col-lg-4">
                          <img src={payment} alt="matdash-img" class="img-fluid" />
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <section class="payment-method text-center">
                ...
                <img src={PaymentComplete} alt="matdash-img" class="img-fluid mb-4" width="350" />
                <p class="mb-0 fs-2">We will send you a notification
                  <br />within 2 days when it ships.
                </p>
                <div class="d-sm-flex align-items-center justify-content-between my-4">
                  <a href="../horizontal/eco-shop.html" class="btn btn-success d-block mb-2 mb-sm-0">Continue Shopping</a>
