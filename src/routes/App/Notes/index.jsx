    ...
    <li class="nav-item">
      <a href="javascript:void(0)" class="
              ...
              gap-6
                ...
                px-3 px-md-3
              " id="note-business">
        <i class="ti ti-briefcase fill-white" />
    ...
    <li class="nav-item">
      <a href="javascript:void(0)" class="
              ...
              gap-6
                ...
                px-3 px-md-3
              " id="note-social">
        <i class="ti ti-share fill-white" />
        ...
        <div class="card card-body">
          ...
          <div class="d-flex align-items-center">
            <a href="javascript:void(0)" class="link me-1">
              <i class="ti ti-star fs-4 favourite-note" />
            </a>
            <a href="javascript:void(0)" class="link text-danger ms-2">
              <i class="ti ti-trash fs-4 remove-note" />
            </a>
            <div class="ms-auto">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="note-description">
                      ...
                      <textarea id="note-has-description" class="form-control" minlength="60" placeholder="Description" rows="3" value="" />
                    </div>
                  </div>
                </div>
              </form>
