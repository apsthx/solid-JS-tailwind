import { User1, User2, User3, User4, User6, User7, User8, Product1, Product2, Product3, Product4, IconChrome, IconAdobe, IconFigma, IconJavascript, IconZipFoldere } from "../../../helper/img";
                  ...
                  <div class="d-flex align-items-center justify-content-between mb-3">
                    <div class="d-flex align-items-center">
                      <div class="position-relative">
                        <img src={User1} alt="user1" width="54" height="54" class="rounded-circle"/>
                  ...
                  <ul class="chat-users mb-0 mh-n100" data-simplebar="">
                      ...
                      <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-start justify-content-between chat-user bg-light-subtle" id="chat_user_1" data-user-id="1">
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src={User3} alt="user1" width="48" height="48" class="rounded-circle"/>
                            <span class="position-absolute bottom-0 end-0 p-1 badge rounded-pill bg-success">
                              <span class="visually-hidden">New alerts</span>
                            </span>
                          </span>
                    ...
                    <li>
                      <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-start justify-content-between chat-user" id="chat_user_2" data-user-id="2">
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src={User2} alt="user-2" width="48" height="48" class="rounded-circle"/>
                    ...
                    <li>
                      <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-start justify-content-between chat-user" id="chat_user_3" data-user-id="3">
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src={User8} alt="user-8" width="48" height="48" class="rounded-circle"/>
                    ...
                    <li>
                      <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-start justify-content-between chat-user" id="chat_user_4" data-user-id="4">
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src={User4} alt="user-4" width="48" height="48" class="rounded-circle"/>
                            <span class="position-absolute bottom-0 end-0 p-1 badge rounded-pill bg-success">
                              <span class="visually-hidden">New alerts</span>
                            </span>
                          </span>
                    ...
                    <li>
                      <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-start justify-content-between chat-user" id="chat_user_5" data-user-id="5">
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src={User6} alt="user1" width="48" height="48" class="rounded-circle"/>
                            <span class="position-absolute bottom-0 end-0 p-1 badge rounded-pill bg-success">
                              <span class="visually-hidden">New alerts</span>
                            </span>
                          </span>
                        ...
                        <div class="chat-box-inner p-9" data-simplebar="">
                          <div class="chat-list chat active-chat" data-user-id="1">
                            <div class="hstack gap-3 align-items-start mb-7 justify-content-start">
                              <img src={User8} alt="user8" width="40" height="40" class="rounded-circle" />
                              <div>
                            ...
                            <div class="hstack gap-3 align-items-start mb-7 justify-content-start">
                              ...
                              <div>
                                ...
                                <div class="rounded-2 overflow-hidden">
                                  <img src={Product1} alt="flexy-img" class="w-100" />
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="offcanvas-body p-9">
                            ...
                            <div class="row mb-7 text-nowrap">
                              <div class="col-4 px-1 mb-2">
                                ...
                                <img src={Product1} width="88" height="65" alt="flexy-img" class="rounded" />

                              </div>
                              <div class="col-4 px-1 mb-2">

                                <img src={Product2} width="88" height="65" alt="flexy-img" class="rounded" />

                              </div>
                              <div class="col-4 px-1 mb-2">

                                <img src={Product3} width="88" height="65" alt="flexy-img" class="rounded" />

                              </div>
                              <div class="col-4 px-1 mb-2">

                                <img src={Product4} width="88" height="65" alt="flexy-img" class="rounded" />
                            ...
                            <div class="files-chat">
                              ...
                              <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between text-nowrap mb-9">
                                <div class="d-flex align-items-center gap-3">
                                  <div class="rounded-1 text-bg-light p-6">
                                    <img src={IconAdobe} alt="flexy-img" width="24" height="24" />
                                  </div>
                                  <div>
                              ...
                              <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between text-nowrap mb-9">
                                <div class="d-flex align-items-center gap-3">
                                  <div class="rounded-1 text-bg-light p-6">
                                    <img src={IconFigma} alt="flexy-img" width="24" height="24" />
                                  </div>
                                  <div>
                                    <h6 class="fw-semibold">
                                      homepage-design.fig
                              ...
                              <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between text-nowrap mb-9">
                                <div class="d-flex align-items-center gap-3">
                                  <div class="rounded-1 text-bg-light p-6">
                                    <img src={IconChrome} alt="flexy-img" width="24" height="24" />
                                  </div>
                                  <div>
                              ...
                              <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between text-nowrap mb-9">
                                <div class="d-flex align-items-center gap-3">
                                  <div class="rounded-1 text-bg-light p-6">
                                    <img src={IconZipFoldere} alt="flexy-img" width="24" height="24" />
                                  </div>
                                  <div>
                                    <h6 class="fw-semibold">
                                      work-project.zip
                              ...
                              <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between text-nowrap">
                                <div class="d-flex align-items-center gap-3">
                                  <div class="rounded-1 text-bg-light p-6">
                                    <img src={IconJavascript} alt="flexy-img" width="24" height="24" />
                                  </div>
                                  <div>
                  ...
                  <ul class="chat-users mh-n100" data-simplebar="">
                    <li>
                      <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-start justify-content-between chat-user bg-light-subtle" id="chat_user_1" data-user-id="1">
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src={User2} alt="user1" width="48" height="48" class="rounded-circle" />
                            <span class="position-absolute bottom-0 end-0 p-1 badge rounded-pill bg-success">
                              <span class="visually-hidden">New alerts</span>
                            </span>
                          </span>
                    ...
                    <li>
                      <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-start justify-content-between chat-user" id="chat_user_5" data-user-id="5">
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src={User7} alt="user1" width="48" height="48" class="rounded-circle" />
                            <span class="position-absolute bottom-0 end-0 p-1 badge rounded-pill bg-success">
                              <span class="visually-hidden">New alerts</span>
                            </span>
                          </span>
