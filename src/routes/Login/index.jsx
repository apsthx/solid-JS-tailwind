import { darkLogo, facebookIcon, googleIcon, lightLogo, loginSecurity } from "../../helper/icon";
                                ...
                                <div class="auth-max-width col-sm-8 col-md-6 col-xl-7 px-4">
                                    ...
                                    <form>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            ...
                                            <a class="text-primary fw-medium fs-3" href="forgotPassword">Forgot Password ?</a>
                                        </div>
