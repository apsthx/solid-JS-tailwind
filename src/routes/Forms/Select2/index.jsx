...
export default function Select2() {
  onMount(() => {
    ...
    // import("../../../assets/libs/select2/dist/js/select2.full.min.js").then(({ initializeSelect2 }) => {
    //   initializeSelect2();
    // });
    // import("../../../assets/libs/select2/dist/js/select2.min.js").then(({ initializeSelect2 }) => {
    //   initializeSelect2();
    // });
    // import("../../../assets/js/forms/select2.init.js").then(({ initializeSelect2 }) => {
    //   initializeSelect2();
    // });
  });
  onMount(async () => {
      ...
      <div class="container-fluid mw-100">
        <div class="page-titles mb-7 mb-md-5">
          <div class="row">
            <div class="col-lg-8 col-md-6 col-12 align-self-center">
              ...
              <h2 class="mb-0 fw-bolder fs-8">Select2</h2>
            </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <select class="form-control" id="select2-data-array" />
