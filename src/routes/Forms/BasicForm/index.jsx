  ...
  <div class="page-titles mb-7 mb-md-5">
    <div class="row">
      <div class="col-lg-8 col-md-6 col-12 align-self-center">
        ...
        <h2 class="mb-0 fw-bolder fs-8">Form Basic</h2>
      </div>
  ...
  <div class="row">
                ...
                <div class="d-md-flex align-items-center">
                  ...
                  <div class="ms-auto mt-3 mt-md-0">
                    <button type="submit" class="btn btn-primary hstack gap-6">
                      <i class="ti ti-send fs-4" />Submit</button>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="card-body">
          ...
          <form>
            <fieldset disabled>
              ...
              <button type="submit" class="btn btn-muted mt-3">Submit</button>
            </fieldset>
          </form>
        </div>
      </div>
    ...
    <div class="col-lg-6">
      <div class="card">
        <div class="card-body">
          ...
          <p class="card-subtitle mb-3">made with bootstrap elements</p>
          <form>
            <div class="form-floating mb-3">
              <input type="text" class="form-control" placeholder="Username" />
              <label>
                <i class="ti ti-user me-2 fs-4" />Username</label>
            </div>
            <div class="form-floating mb-3">
              <input type="email" class="form-control" placeholder="Email" />
              <label>
                <i class="ti ti-mail me-2 fs-4" />Email address</label>
            </div>
            <div class="form-floating mb-3">
              <input type="password" class="form-control" placeholder="Password" />
              <label>
                <i class="ti ti-lock me-2 fs-4" />Password</label>
            </div>
            <div class="form-floating mb-3">
              <input type="password" class="form-control" placeholder="CPassword" />
              <label>
                <i class="ti ti-lock me-2 fs-4" />Confirm Password</label>
            </div>
            <div class="d-md-flex align-items-center">
              <div class="form-check">
        ...
        <div class="card-body">
          ...
          <form>
            <div class="form-floating mb-3">
              ...
              <label>
                <i class="ti ti-user me-2 fs-4 text-info" />
            ...
            <div class="form-floating mb-3">
              ...
              <label>
                <i class="ti ti-mail me-2 fs-4 text-info" />
            ...
            <div class="form-floating mb-3">
              ...
              <label>
                <i class="ti ti-lock me-2 fs-4 text-info" />
            ...
            <div class="d-md-flex align-items-center">
              ...
              <div class="mt-3 mt-md-0 ms-auto">
                <button type="submit" class="btn btn-info hstack gap-6">
                  <i class="ti ti-send me-2 fs-4" />Submit</button>
              </div>
            </div>
          </form>
        </div>
        ...
        <div class="card-body">
          ...
          <form>
            <div class="form-floating mb-3">
              ...
              <label>
                <i class="ti ti-user me-2 fs-4 text-warning" />
            ...
            <div class="form-floating mb-3">
              ...
              <label>
                <i class="ti ti-mail me-2 fs-4 text-warning" />
            ...
            <div class="form-floating mb-3">
              ...
              <label>
                <i class="ti ti-lock me-2 fs-4 text-warning" />
        ...
        <div class="card-body">
          ...
          <form>
            <div class="form-floating mb-3">
              ...
              <label>
                <i class="ti ti-user me-2 fs-4 text-primary" />
            ...
            <div class="form-floating mb-3">
              ...
              <label>
                <i class="ti ti-mail me-2 fs-4 text-primary" />
            ...
            <div class="form-floating mb-3">
              ...
              <label>
                <i class="ti ti-lock me-2 fs-4 text-primary" />
        ...
        <div class="card-body">
          ...
          <form>
            <div class="form-floating mb-3">
              ...
              <label>
                <i class="ti ti-user me-2 fs-4 text-success" />
            ...
            <div class="form-floating mb-3">
              ...
              <label>
                <i class="ti ti-mail me-2 fs-4 text-success" />
            ...
            <div class="form-floating mb-3">
              ...
              <label>
                <i class="ti ti-lock me-2 fs-4 text-success" />
        ...
        <div class="card-body">
          ...
          <form>
            <div class="form-floating mb-3">
              ...
              <label>
                <i class="ti ti-user me-2 fs-4 text-danger" />
            ...
            <div class="form-floating mb-3">
              ...
              <label>
                <i class="ti ti-mail me-2 fs-4 text-danger" />
            ...
            <div class="form-floating mb-3">
              ...
              <label>
                <i class="ti ti-lock me-2 fs-4 text-danger" />
    ...
    <div class="col-12">
      <div class="card card-body">
        ...
        <p class="card-subtitle mb-3">All bootstrap element classies</p>
          ...
          <div>
            ...
            <div class="form-actions">
              <div class="card-body border-top">
                ...
                <button type="button" class="btn bg-danger-subtle text-danger ms-6">Cancel</button>
              </div>
            </div>
          </div>
        </form>
                  ...
                  <div class="input-group mb-2">
                    <div class="input-group-text">
                      <div class="form-check">
                        ...
                        <label class="form-check-label" for="checkbox00">
                        </label>
                      </div>
                    </div>
                    <span class="input-group-text">0.00</span>
                  ...
                  <div class="input-group mb-3">
                    <button class="btn bg-danger-subtle text-danger" type="button">
                      <div class="d-flex align-items-center">
                        <i class="ti ti-circle-half me-1 fs-4" />Hate It</div>
                    </button>
                    <input type="text" class="form-control" placeholder aria-label aria-describedby="basic-addon1" />
                    <button class="btn btn-danger" type="button">
                      <div class="d-flex align-items-center">
                        <i class="ti ti-heart me-1 fs-4" />Love It</div>
                    </button>
                  </div>
                </div>
              </div>
          ...
          <div class="col-sm-12 col-xs-12">
            ...
            <form class="input-form">
              <div class="row">
                <div class="col-lg-6">
                  <div class="input-group mb-3">
                    <button class="btn bg-primary-subtle text-primary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>
    ...
    <div class="col-12">
      <div class="card card-body">
        ...
        <p class="card-subtitle mb-3">Validation styles for error, warning, and success states on form controls.</p>
        <div class="row">
          <div class="col-md-6">
