...
//     import("../../../assets/js/forms/form-wizard.js").then(({ initializeDataTableAdvanced }) => {
//         initializeDataTableAdvanced();
//     });
// });
onMount(async () => {
  const module = await import("../../../assets/js/forms/form-wizard.js");

  module.initializeWizard();
});
  return (
    <>
        ...
        <div class="page-titles mb-7 mb-md-5">
          <div class="row">
            <div class="col-lg-8 col-md-6 col-12 align-self-center">
              ...
              <h2 class="mb-0 fw-bolder fs-8">Form Wizard</h2>
            </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="mb-3">
                      ...
                      <textarea name="shortDescription" id="shortDescription1" rows="6" class="form-control" value="" />
                    </div>
                  </div>
                </div>
              </section>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <textarea name="decisions" id="decisions1" rows="4" class="form-control" value="" />
                    </div>
                    <div class="mb-3">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="mb-3">
                      ...
                      <textarea name="shortDescription" id="shortDescription3" rows="6" class="form-control" value="" />
                    </div>
                  </div>
                </div>
              </section>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <textarea name="decisions" id="decisions3" rows="4" class="form-control" value="" />
                    </div>
                    <div class="mb-3">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="mb-3">
                      ...
                      <textarea name="shortDescription" id="shortDescription2" rows="6" class="form-control" value="" />
                    </div>
                  </div>
                </div>
              </section>
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="mb-3">
                      ...
                      <select class="form-select" id="intType2" data-placeholder="Type to search cities" name="intType2">
                        <option value="Banquet">Normal</option>
                        <option value="Fund Raiser">Difficult</option>
                        <option value="Dinner Party">Hard</option>
                      </select>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <textarea name="decisions" id="decisions2" rows="4" class="form-control" value="" />
                    </div>
                    <div class="mb-3">
            ...
            <form id="example-form" action="#" class="mt-5">
              <div>
                ...
                <section>
                  ...
                  <input id="email" name="email" type="text" class="required email form-control mb-3" autocomplete="on" />
          ...
          <div class="card-body">
            ...
            <form id="example-advanced-form" action="#" class="mt-5">
              ...
              <fieldset>
                ...
                <input id="userName-2" name="userName" type="text" class="required form-control  mb-3" autocomplete="on" />
                <label class="form-label" for="password-2">Password *</label>
                <input id="password-2" name="password" type="password" class="required form-control mb-3" autocomplete="current-password" />
              ...
              <fieldset>
                ...
                <input id="email-2" name="email" type="text" class="required email form-control mb-3" autocomplete="on" />
            ...
            <div id="example-manipulation" class="mt-5">
              ...
              <section>
                <p>
                  ...
                  <br />
                  <textarea id="text-3" rows="5" class="form-control" value="" />
                </p>
                <p>
              ...
              <section>
                <p>
                  ...
                  <br />
                  <textarea id="text2-3" rows="5" class="form-control" value="" />
                </p>
                <p>
