  ...
  <div class="page-titles mb-7 mb-md-5">
    <div class="row">
      <div class="col-lg-8 col-md-6 col-12 align-self-center">
        ...
        <h2 class="mb-0 fw-bolder fs-8">Form Actions</h2>
      </div>
          ...
          <div class="card-body">
            ...
            <div class="alert bg-primary-subtle text-primary alert-dismissible fade show" role="alert">
              <div class="d-flex align-items-center text-primary ">
                <i class="ti ti-info-circle me-2 fs-4" />
            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="mb-3">
                  ...
                  <textarea class="form-control" aria-label="With textarea" placeholder="About Project Here" value=""/>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="card-body border-top">
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <textarea class="form-control" aria-label="With textarea" placeholder="Bio Here" value=""/>
            </div>
          </div>
        </div>
            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="mb-3">
                  ...
                  <textarea class="form-control" id="exampleTextarea1" rows="2" placeholder="Comments Here" value=""/>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-12">
                <div class="mb-3">
                  ...
                  <textarea class="form-control" id="exampleTextarea2" rows="2" placeholder="Complaint Here" value=""/>
                </div>
              </div>
              <div class="col-12">
                <div class="mb-3">
            ...
            <div class="row">
              ...
              <div class="col-sm-12 col-md-6">
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <span class="input-group-text" id="basic-addon1">
                      <i class="ti ti-clock-hour-4 fs-4" />
                    </span>
              ...
              <div class="col-12">
                <div class="mb-3">
                  ...
                  <textarea class="form-control" id="exampleTextarea10" rows="3" placeholder="Notes Here" value=""/>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card-body border-top">
            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="mb-3">
                  <label class="form-label">Comments</label>
                  <textarea class="form-control" id="exampleTextarea20" rows="2" placeholder="Comments Here" value=""/>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="ms-auto d-flex align-items-center flex-wrap gap-6">
                ...
                <div class="btn-group">
                  <button type="button" class="btn btn-danger dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="ti ti-transition-right me-1 fs-4" />
                    Export
                  </button>
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="javascript:void(0)">Action</a>
                ...
                <div class="btn-group">
                  <button type="button" class="btn btn-success dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="ti ti-upload me-1 fs-4" />
                    Upload
                  </button>
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="javascript:void(0)">Action</a>
