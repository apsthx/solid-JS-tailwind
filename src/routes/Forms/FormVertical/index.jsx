  ...
  <div class="page-titles mb-7 mb-md-5">
    <div class="row">
      <div class="col-lg-8 col-md-6 col-12 align-self-center">
        ...
        <h2 class="mb-0 fw-bolder fs-8">Vertical Form</h2>
      </div>
      ...
      <div class="card">
        ...
        <div class="card-body p-4">
          ...
          <div class="mb-4">
            ...
            <textarea class="form-control p-7" name id cols="20" rows="1" placeholder="Hi, Do you  have a moment to talk Jeo ?" value="" />
          </div>
        ...
        <div class="card-body p-4">
          ...
          <div class="mb-4">
            ...
            <div class="input-group">
              ...
              <textarea class="form-control p-7 ps-2" name id cols="20" rows="1" placeholder="Hi, Do you  have a moment to talk Jeo ?" value="" />
            </div>
          </div>
          <button class="btn btn-primary">Send</button>
        </div>
            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="mb-4">
                  ...
                  <textarea class="form-control p-7" name id cols="20" rows="1" placeholder="150, Ring Road" value="" />
                </div>
              </div>
              <div class="col-lg-6">
                <div class="mb-4">
