...
// const module = await import("../assets/libs/simplebar/dist/simplebar.min.js");
    ...
    if ((at = "vertical")) {
      ...
      if (currentNewURL.includes("/docs/introduction")) {
        current_link.setAttribute("href", "/docs/introduction");
      } else if (currentNewURL.includes("/introduction")) {
        current_link.setAttribute("href", "./introduction");
      } else {
